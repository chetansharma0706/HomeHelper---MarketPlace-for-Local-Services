        ...
        <div className="absolute inset-0 w-[80%] flex flex-col items-center justify-start text-center text-white px-4 pt-32 mx-auto md:w-[68%]">
          ...
          <div className="relative flex items-center w-full max-w-xl mb-5">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="px-4 py-2 w-full rounded-xl bg-extremeLightGray text-black focus:outline-none md:px-6 md:py-4"
            />
            {/* Search Button inside the input */}
            <button className="absolute right-0 top-0 bottom-0 px-4 bg-primaryColor text-white rounded-r-md hover:bg-secondaryColor">
