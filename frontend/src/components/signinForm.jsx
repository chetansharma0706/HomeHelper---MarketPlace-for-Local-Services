...
const signinForm = () => {
    return (
        <div className="absolute inset-5 flex-1 flex items-center justify-center p-8">
                ...
                <form onSubmit={handleSignUp} className="mt-8 space-y-6">
                    <div className="flex flex-col rounded-md shadow-sm space-y-2">
                        ...
                        <div>
                            ...
                            <input id="password" name="password" value={formData.password} type="password" onChange={handleChange} autoComplete="current-password" required className="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-primaryColor focus:border-primaryColor focus:z-10 sm:text-sm" placeholder="Password" />
                        </div>
                    </div>
